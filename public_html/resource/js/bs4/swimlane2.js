  ...
  $(document).ready(function () {
    ...
    $(document).on("change", '#projectListSwimlane', function (e) {
    ...
    $(document).on("click", '#testjsndj', function (e) {
      genProccesList();
      $('#projectListSwimlane').change();
    })
    $(document).on("click", '#newProcessName', function (e) {
      $("#newProcessNameInput").show();
      $("#newProcessNameInput").focus();
      $(this).hide();
    })
    $(document).on("keypress", '#newProcessNameInput', function (e) {
      if (e.which == 13) {
        var dt = $(this).val()
        if (dt.trim().length > 3) {
          var set = triggerAPI(this, '21061417550001624882');
    ...
    $(document).on("click", '#editNameProcess', function (e) {
      new UserStory().setGUIComponentButtonGUIModal('21061514350000261100', this);
      var dt = be.callApi('21061514462500255839')
      triggerAPI(this, '21061514462500255839');
    ...
    $(document).on("click", '#deleteProcessName', function (e) {
      ...
      triggerAPI(this, '21061513313505523976');
      document.location.reload();

    })
    $(document).on("focusout", '#newProcessNameInput', function (e) {
    ...
    function addLaneApi() {
      ...
      var prcId = $('#projectListSwimlane').val()
      var prop = {
        "kv": {
          "laneName": "Lane",
          "orderNo": on,
    ...
    function figureAddBlock(el, clr, nm, id, UsCaId, fgText, ftSzTxt, ftSzTxt) {
      ...
      return $("<div>")
        ...
        .append($("<div>")
          ...
          .append($("<div>").addClass("ContentBody StickMnbody")
            .append('<span style="font-size:' + ftSzTxt + 'px;" >' + fgText + '</span>')))
    ...
    $(document).on("change", "#select-text", function () {
      ...
      var data ={};
      data.id = idFigure
      data.figureText = textVal;

      var dt = be.callApi('21061117322902275178',data);
    ...
    $(document).on("change", "#selecttextfontSize", function () {
      ...
      var id = $('[data-text="TextVal"]').attr("id");
