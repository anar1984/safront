var LeaderLine = function () {
    "use strict";
    var Z, w, O, M, I, o, t, s, h, u, n, a, e, _, v, l, r, i, E, x, p, c, d, C = "leader-line",
        b = 1,
        k = 2,
        L = 3,
        A = 4,
        ...
        g = (_ = {
            ...
            add: function (n, e, t, a, i, o, l) {
                ...
                if ("string" == typeof i && (i = _[i]), n = n || function () {}, t < v) r = [g(0, 0), g(1, 1)];
                else {
                    if (s = v / t, r = [g(0, 0)], 0 === i[0] && 0 === i[1] && 1 === i[2] && 1 === i[3])
                        for (h = s; h <= 1; h += s) r.push(g(h, h));
                    else
                        for (p = u = (h = s) / 10; p <= 1; p += u) d = p, m = y = f = void 0, f = (m = p * p) * p, m *= 3 * (y = 1 - p), h <= (c = {
        ...
        ce = function (e) {
            e.SVGPathElement.prototype.getPathData && e.SVGPathElement.prototype.setPathData || function () {
                ...
                i.prototype = {
                    ...
                    _parseNumber: function () {
                        ...
                        if (this._currentIndex !== r)
                            for (var s = this._currentIndex - 1, u = 1; r <= s;) t += u * (this._string[s] - "0"), --s, u *= 10;
                ...
                e.SVGPathElement.prototype.setAttribute = function (e, t) {
                    ...
                    var s, u, h, p, c, t = n(this.getAttribute("d") || "");
                    return this[d] = l(t), t
        ...
        S = (a = {}, Ee.m = n = [function (e, t, n) {
            ...
            if (Ee.r(n), Object.defineProperty(n, "default", {
                ...
                for (var a in t) Ee.d(n, a, function (e) {
                    return t[e]
                }.bind(null, a));
            return n
        }, Ee.n = function (e) {
    ...
    function Te(n, a, i, o, e) {
        ...
        var r, s, u = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472],
            h = 0,
    ...
    function Ke(l) {
        var g, c, _, e, n, a, i, d, o, r, s, t, u, h, p = l.options,
            f = l.curStats,
            y = l.aplStats,
                ...
                case B:
                    ! function () {
                        ...
                        for (v.forEach(function (e, t) {
                            ...
                            function () {
                                var e, t, a, i, n = [d(u[1], u[0]), d(u[0], u[1])],
    ...
    function $e(e, t) {
        var n, a, h, p, c, d, f, i, o, l, r, s, u, y, m, S, g, _, v, E, x, b, k, w, O, M, I, C, L, A, V, P, N, T, W, B, R, F, G, D, z, j, H, U = {};
    ...
    function it(s, u) {
        var i, n, e, t, a, o, l, r, h, p, c, d, f, y, m, S = s.options,
            g = {};
    ...
    return Z = {
        ...
        dropShadow: {
            ...
            init: function (t) {
                var e, n, a, i, o = t.baseWindow.document,
                    l = t.defs,
        ...
        draw: {
            ...
            stop: function (e, t, n) {
                var a, i = e.curStats;
                return n = null != n ? n : e.aplStats.show_on, a = i.show_inAnim ? g.stop(i.show_animId) : n ? 1 : 0, i.show_inAnim = !1, t && (e.pathList.animVal = n ? null : [
        ...
        Object.defineProperty(ot.prototype, a, {
            get: function () {
                var t, n = null != l ? Se[this._id].options[o][l] : o ? Se[this._id].options[o] : Se[this._id].options[a];
        ...
        Object.defineProperty(ot.prototype, n, {
            get: function () {
                var s, e, t = Se[this._id].options[n];
    ...
    }, M = rt, window.LeaderLineAttachment = M, I = function (e, t) {
        ...
        areaAnchor: {
            ...
            update: function (t) {
                var n, a, i, o, e, l, r, s, u, h, p, c, d, f, y, m, S = t.curStats,
                    g = t.aplStats,
                ...
                if (v.strokeWidth = Xe(t, S, "strokeWidth", null != t.size ? t.size : _ ? _.line_strokeWidth : ue.lineSize), n = Ie(t.element), v.elementWidth = Xe(t, S, "elementWidth", n.width), v.elementHeight = Xe(t, S, "elementHeight", n.height), v.elementLeft = Xe(t, S, "elementLeft", n.left), v.elementTop = Xe(t, S, "elementTop", n.top), v.strokeWidth || t.hasRatio && (v.elementWidth || v.elementHeight)) {
                    switch (t.shape) {
                        case "rect":
                            ...
                            ], h[1].x !== h[2].x && S.pathListRel.push([h[1], h[2]]), S.pathListRel.push([h[2], {
                                x: h[2].x + p,
                                y: h[2].y
                            }, {
                                x: h[3].x,
                        ...
                        case "circle":
                            (l = {
                                ...
                                width: t.width[0] * (t.width[1] ? n.width : 1),
                                height: t.height[0] * (t.height[1] ? n.height : 1)
                            }).width || l.height || (l.width = l.height = 10), l.width || (l.width = l.height), l.height || (l.height = l.width), l.right = l.left + l.width, l.bottom = l.top + l.height, p = l.left + l.width / 2, r = l.top + l.height / 2, e = S.strokeWidth / 2, s = l.width / 2, u = l.height / 2, c = s * Math.SQRT2 + e, h = u * Math.SQRT2 + e, S.pathListRel = [
                                [(e = [{
                                    x: p - c,
                                    y: r
                                }, {
                                ...
                                []
                            ], s = c - s + S.strokeWidth / 2, u = h - u + S.strokeWidth / 2, e = [{
                                x: l.left - s,
                                y: l.top - u
                            }, {
                                x: l.right + s,
        ...
        mouseHoverAnchor: {
            ...
            init: function (a, i) {
                var n, t, e, o, l, r, s, u, h, p = O.mouseHoverAnchor,
                    c = {};
            ...
            bind: function (e, t) {
                ...
                }) : (console.warn("mouseenter and mouseleave events polyfill is enabled."), n.addEventListener("mouseover", o = function (e) {
                ...
                }), n.addEventListener("mouseout", l = function (e) {
        ...
        captionLabel: {
            ...
            newText: function (e, t, n, a, i) {
                var o, l, r = t.createElementNS(ae, "text");
            ...
            initSvg: function (t, n) {
                var e, a, i = O.captionLabel.newText(t.text, n.baseWindow.document, n.svg, C + "-captionLabel-" + t._id, t.outlineColor);
        ...
        pathLabel: {
            ...
            newText: function (e, t, n, a) {
                var i, o, l, r, s = t.createElementNS(ae, "defs"),
            ...
            initSvg: function (t, n) {
                var e, a, i, o = O.pathLabel.newText(t.text, n.baseWindow.document, C + "-pathLabel-" + t._id, t.outlineColor);
