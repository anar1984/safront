...
var LeaderLine = function () {
    ...
    function Re(e) {
        var t, n = e.document;
        n.getElementById(r) || (t = (new e.DOMParser).parseFromString(s, "image/svg+xml"), n.getElementById("gui_component_main_view").appendChild(t.documentElement), d(e))
    }
    ...
    function Ze(s, u) {
        ...
        i && (e = function (e, t) {
            ...
            }), a.plugsFace = o = a.face.appendChild(d.createElementNS(b, "use")), o.className.baseVal = v + "-plugs-face", o.href.baseVal = "#" + r, o.style.display = "none", a.curStats.show_inAnim ? (a.isShown = 1, g[c.show_effect].stop(a, !0)) : a.isShown || (t.style.visibility = "hidden"), d.getElementById("gui_component_main_view").appendChild(t), [0, 1, 2].forEach(function (e) {
