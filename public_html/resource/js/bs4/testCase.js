...
function getBugListDetailsHeader() {
    var th = $('<tr>')
            ...
            .append($('<th>').addClass('bug-list-column')
                    .addClass('bug-list-column-assignee').append('<i class="cs-svg-icon task-user-1"></i>'))
            .append($('<th>').addClass('bug-list-column')
            ...
            .append($('<th>').addClass('bug-list-column')
                    .addClass('bug-list-column-created-by').append('<i class="cs-svg-icon task-user-2"></i>'))
            .append($('<th>').addClass('bug-list-column')
